<script>
	...
	// import Audio from './Settings/Audio.svelte'; // Hidden - configured via env vars
	...
	$: {
		...
		selectedTab = [
			...
			'code-execution',
			'interface',
			// 'audio', // Hidden - audio settings are configured via environment variables
			'images',
			'pipelines',
			'db'
...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
	...
	>
		...
		<!-- Audio tab hidden - audio settings are configured via environment variables for offline deployments -->
